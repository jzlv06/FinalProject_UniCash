...
namespace FinalProject_UniCash
{
    public partial class Gateway : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var collection = database.GetCollection<BsonDocument>("gatewayinfo");
            ...
            gatewayGridView.DataSource = dataTable;
            gatewayGridView.DataBind();
        }

        protected void submitButton5_Click(object sender, EventArgs e)
        {
            var connectionString = "mongodb://localhost:27017";
            var client = new MongoClient(connectionString);
            IMongoDatabase db = client.GetDatabase("InsertRetrieveData_UniCash");
            var collection = db.GetCollection<BsonDocument>("gatewayinfo");
            ...
            lblMsg5.Text = "Data Inserted Into Database.";
