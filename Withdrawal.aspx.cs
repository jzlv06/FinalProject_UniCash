...
namespace FinalProject_UniCash
{
    public partial class Withdrawal : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var collection = database.GetCollection<BsonDocument>("withdrawalinfo");
            ...
            withdrawalGridView.DataSource = dataTable;
            withdrawalGridView.DataBind();
        }
        ...
        protected void submitButton4_Click(object sender, EventArgs e)
        {
            ...
            var collection = db.GetCollection<BsonDocument>("withdrawalinfo");
            var insertdata = new BsonDocument
            {
                { "Withdrawal ID", withdrawalIDNumTextbox.Text},    
                ...
                { "Withdrawal Amount", withdrawalAmountTextbox.Text},
                { "Withdrawal Status", withdrawalStatusTextbox.Text}
            };
            collection.InsertOne(insertdata);
            lblMsg4.Text = "Data Inserted Into Database.";
